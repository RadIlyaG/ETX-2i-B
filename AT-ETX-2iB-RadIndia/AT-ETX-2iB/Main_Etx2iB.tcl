proc BuildTests {} {
  ...
  if {$b!="DNFV"} {
    if {[info host]=="ate-dbg01-w10"} {
      set lDownloadTests [list  SetDownload  SoftwareDownload]
    } else {
...
#   GREEN \'LINK/ACT\' leds of ports are ON or blinking"
  ...
  if {[info host]=="ate-dbg01-w10"} {
    set txt "Connect the \'MNG-ETH\' cable and verify that:\n\
    GREEN \'LINK\' and ORANGE \'ACT\' leds of \'MNG-ETH\' are ON\n\
...
proc LedsSingle {} {
  ...
  RLSound::Play information
  if {[info host]=="ate-dbg01-w10"} {
    set txt "Disconnect the \'MNG-ETH\' cable and verify that:\n\
    GREEN \'PWR\' led is ON\n\
